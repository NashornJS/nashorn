...
import static nashorn.internal.codegen.ClassEmitter.Flag.PRIVATE;
import static nashorn.internal.codegen.ClassEmitter.Flag.STATIC;
...
import static nashorn.internal.codegen.CompilerConstants.GET_MAP;
import static nashorn.internal.codegen.CompilerConstants.GET_STRING;
import static nashorn.internal.codegen.CompilerConstants.QUICK_PREFIX;
import static nashorn.internal.codegen.CompilerConstants.REGEX_PREFIX;
...
import static nashorn.internal.ir.Symbol.HAS_SLOT;
...
import static nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_APPLY_TO_CALL;
import static nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_DECLARE;
import static nashorn.internal.runtime.linker.NashornCallSiteDescriptor.CALLSITE_FAST_SCOPE;
...
import nashorn.internal.AssertsEnabled;
...
final class CodeGenerator extends NodeOperatorVisitor<CodeGeneratorLexicalContext> implements Loggable {
    ...
    private MethodEmitter globalAllocateArray(final ArrayType type) {
        ...
        return method.invokestatic(GLOBAL_OBJECT, "allocate", "(" + type.getDescriptor() + ")Lnashorn/internal/objects/NativeArray;");
    }
